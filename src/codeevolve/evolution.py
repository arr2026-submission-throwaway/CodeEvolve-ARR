...
def select_parents(
    ...
    if gen_init_pop:
        logger.info("Generating initial population: selecting initial solution and prompt as parents.")
        parent_sol = init_sol
...
async def evolve_loop(
    ...
    for epoch in range(start_epoch + 1, evolve_config["num_epochs"] + 1):
        ...
        exploration: bool = not gen_init_pop and sol_db.random_state.uniform(0, 1) <= exploration_rate
